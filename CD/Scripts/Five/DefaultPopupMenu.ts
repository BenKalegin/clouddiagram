module Five {
    ...
    export interface IPopupMenuCallback {
        execute(action: string, cell: Cell);
        getSelectionCount(): number;
        isCellFoldable(cell: Cell, _false: boolean): boolean;
    ...
    export class DefaultPopupMenu {
         ...
         */
        createMenu(editor: IPopupMenuCallback, menu: PopupMenu, cell?: Cell, evt?: MouseEvent) {
            if (this.config != null) {
         ...
         */
        private addItems(editor: IPopupMenuCallback, menu: PopupMenu, cell?: Cell, evt?: MouseEvent, conditions?: string[], item?: Element, parent?: Element) {
         ...
         */
        private addAction(menu: PopupMenu, editor: IPopupMenuCallback, lab: string, icon?:string, funct?:Function, action?:string, cell?:Cell, parent?:Element, iconCls?:string) {
        ...
        private createConditions(editor: IPopupMenuCallback, cell: Cell, evt: MouseEvent) {

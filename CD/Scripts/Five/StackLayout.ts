    ...
    export class StackLayout extends BasicLayout implements ILayout {
        ...
        private getParentSize(parent: Cell): Geometry {
            ...
            if (this.graph.container != null && ((pgeo == null &&
                ...
                pgeo = new Geometry(new Rectangle( 0, 0, offset.x - 1, offset.y - 1));
            }

            return pgeo;
        }

        /** Implements GraphLayout.execute. Only children where <isVertexIgnored> returns false are taken into account. */
        public execute(parent: Cell) {
            if (parent != null) {
                ...
                if (this.graph.isSwimlane(parent)) {
                    ...
                    var start = style.startSize || Constants.defaultStartsize;

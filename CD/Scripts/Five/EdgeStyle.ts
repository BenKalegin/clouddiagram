    ...
    export class EdgeStyle {
        ...
        static loop(state: CellState, source: CellState, target: CellState, points: Point[], result: Point[]) {
            ...
            if (source != null) {
                ...
                var dir = state.style.direction || Direction.West;

                if (dir.valueOf() === Direction.North || dir === Direction.South) {
                ...
                if (pt == null ||
                    ...
                    if (pt != null) {
                        ...
                        if (dir.valueOf() === Direction.North) {
                            y = source.y - 2 * dx;
        ...
        static elbowConnector(state: CellState, source: CellState, target: CellState, points: Point[], result: Point[]) {
            ...
            if (!horizontal && (vertical || state.style.elbow == ElbowStyle.Vertical)) {
...
// EdgeStyle.SOURCE_MASK | EdgeStyle.TARGET_MASK,
	 ...
	 */
        static orthConnector(state: CellState, source: CellState, target: CellState, points: Point[], result: Point[]) {
            var sourceEdge = source == null ? false : Cells.isEdge(source.cell);
            var targetEdge = target == null ? false : Cells.isEdge(target.cell);

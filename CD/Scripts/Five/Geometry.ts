module Five {
    ...
    export class Geometry extends Rectangle implements IPresentationGeometry, IPresentationGeometryChange {

        constructor(bounds?: Rectangle, private sizeRestrictions?: ICellSizeRestrictions) {
            super();
            if (bounds) {
                this.x = bounds.x;
                this.y = bounds.y;
        ...
        getBounds(): Rectangle { return this; }
    }
}
module Five {
    ...
    export class Cells {
        ...
        static getValue(cell: Cell): Node {
            return (cell != null) ? cell.getValue() : null;
        }

        static isEdge(cell: Cell): boolean {
            return (cell != null) ? cell.isEdge() : false;
        }

        static isVertex(cell: Cell): boolean {
            return (cell != null) ? cell.isVertex() : false;
        }

        static getStyle(cell: Cell): AppliedStyle {
            return (cell != null) ? cell.getStyle() : null;
        }

        static isVisible(cell: Cell): boolean {
            return (cell != null) ? cell.isVisible() : false;
        }

        static getParent(cell: Cell): Cell {
            return (cell != null) ? cell.getParent() : null;
        }

        static getChildCount(cell: Cell) {
            return (cell != null) ? cell.getChildCount() : 0;
        }

        static getChildAt(cell: Cell, index: number): Cell {
            return (cell != null) ? cell.getChildAt(index) : null;
        }

		static getEdgeCount(cell: Cell): number {
            return (cell != null) ? cell.getEdgeCount() : 0;
        }

        static getEdgeAt(cell: Cell, index: number): Cell {
            return (cell != null) ? cell.getEdgeAt(index) : null;
        }

		static getTerminal(edge: Cell, isSource: boolean): Cell {
            return (edge != null) ? edge.getTerminal(isSource) : null;
        }

        static isCollapsed(cell: Cell): boolean {
            return (cell != null) ? cell.isCollapsed() : false;
        }

		static isAncestor(parent: Cell, child: Cell) {
    ...
    export class Cell implements IPresentationNodeElement, IPresentationLinkElement {
        constructor(value?: any, geometry?: Geometry, style?: AppliedStyle) {
        ...
        startChangeGeometry(): IPresentationGeometryChange {
            return createGeomtryChange(this);
        }

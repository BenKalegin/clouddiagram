module Five {
    ...
    export class CellEditor {
        ...
        installListeners(elt) {
            ...
            var evtName = (!Client.isIe || Client.isIe9) ? "input" : "keypress";
        ...
        resize() {
            if (this.textDiv != null) {
                ...
                if (state == null) {
                    ...
                    var spacingTop = ((state.style.spacingTop || 0) + TextShape.baseSpacingTop) * scale + spacing;
                    var spacingRight = (state.style.spacingRight || 0 + TextShape.baseSpacingRight) * scale + spacing;
                    var spacingBottom = (state.style.spacingBottom || 0 + TextShape.baseSpacingBottom) * scale + spacing;
                    var spacingLeft = (state.style.spacingLeft + TextShape.baseSpacingLeft) * scale + spacing;
        ...
        startEditing(cell: Cell, trigger: MouseEvent) {
            ...
            if (state != null) {
                ...
                var family = state.style.fontFamily || Constants.defaultFontFamily;
                var color = state.style.fontColor || "black";
                var align = state.style.hAlign || HorizontalAlign.Left;
                var fontStyle = <number>state.style.fontStyle || 0;
                var bold = (fontStyle & FontStyle.Bold) == FontStyle.Bold;
                var italic = (fontStyle & FontStyle.Italic) == FontStyle.Italic;
                var uline = (fontStyle & FontStyle.Underline) == FontStyle.Underline;
                ...
                this.textarea.style.textAlign = HorizontalAlign[align];
 ...
 */
        ...
        private getEditorBounds(state: CellState) {
            ...
            if (Cells.isVertex(state.cell)) {
                var horizontal = state.style.hAlign || HorizontalAlign.Center;
                ...
                var vertical = state.style.vLabelPosition || VerticalAlign.Middle;

                if (vertical == VerticalAlign.Top) {

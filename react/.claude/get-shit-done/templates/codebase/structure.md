...
- Usage: Reference from command with `@/Users/veniamin.kalegin/repos/github/clouddiagram/react/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/veniamin.kalegin/repos/github/clouddiagram/react/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/veniamin.kalegin/repos/github/clouddiagram/react/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

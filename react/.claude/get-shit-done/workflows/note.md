...
- **Global scope**: `/Users/veniamin.kalegin/repos/github/clouddiagram/react/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/veniamin.kalegin/repos/github/clouddiagram/react/.claude/notes/`)
...
2. Glob `/Users/veniamin.kalegin/repos/github/clouddiagram/react/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/veniamin.kalegin/repos/github/clouddiagram/react/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/veniamin.kalegin/repos/github/clouddiagram/react/.claude/notes/` — works in any directory

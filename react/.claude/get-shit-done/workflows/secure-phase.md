...
```
Task(
  prompt="Read /Users/veniamin.kalegin/repos/github/clouddiagram/react/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/veniamin.kalegin/repos/github/clouddiagram/react/.claude/get-shit-done/templates/SECURITY.md`

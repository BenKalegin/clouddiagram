...
import {DiagramEditor, DiagramHandler, Linking} from "./diagramEditorModel";
import {ElementType, Id} from "../../package/packageModel";
import {select} from "typed-redux-saga";
import {selectActiveDiagramId} from "../diagramTabs/diagramTabsSlice";
...
import {findTargetActivation} from "../sequenceDiagram/model";
...
export interface DiagramEditorActionHandler {

}

function getHandlerByType(type: ElementType): DiagramHandler {
    switch (type) {
        case ElementType.ClassDiagram:
            return new ClassDiagramHandler();

        case ElementType.SequenceDiagram:
            return new SequenceDiagramHandler();

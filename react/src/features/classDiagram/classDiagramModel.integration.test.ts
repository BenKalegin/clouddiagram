...
describe('Class Diagram Integration Tests', () => {
  ...
  describe('addNewElementAt', () => {
    it('should add a class node to the diagram', () => {
      // Arrange
      ...
      expect(node.text).toBe('TestClass');
  ...
  describe('handleStructureElementPropertyChanged', () => {
    it('should change a class node property', () => {
      // Arrange
      // First add a node
      const droppedAt: Coordinate = { x: 100, y: 50 };
      const name = 'TestClass';
      ...
      expect(updatedNode.text).toBe('UpdatedClass');
    });
  });

  describe('handleStructureElementCommand', () => {
    it('should delete a class node', () => {
      // Arrange
      // First add a node
      const droppedAt: Coordinate = { x: 100, y: 50 };
      const name = 'TestClass';
  ...
  describe('autoConnectNodes', () => {
    it('should connect two class nodes with a link', () => {
      // Arrange
      // Add two nodes
  ...
  describe('addNodeAndConnect', () => {
    it('should create a new class node and connect it to an existing one', () => {
      // Arrange
      // Add a node
      const droppedAt: Coordinate = { x: 100, y: 50 };
      const name = 'Class1';
      ...
      // Act
      addNodeAndConnect(get, set, 'NewClass');
      ...
      expect(newNode.text).toBe('NewClass');

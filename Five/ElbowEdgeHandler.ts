    ...
    export class ElbowEdgeHandler extends EdgeHandler implements ICellHandler {
        ...
        * exist then the value is used as the error message. Default is 'doubleClickOrientation'. */
        ...
        private getCursorForBend(): string {
            return (/* this.state.style[Constants.styleEdge] == EdgeStyle.topToBottom ||*/
                    this.state.style[Constants.styleEdge] == Constants.edgestyleToptobottom ||
                    ( (/*this.state.style[Constants.styleEdge] == EdgeStyle.elbowConnector() ||*/
                            this.state.style[Constants.styleEdge] == Constants.edgestyleElbow) &&
                        this.state.style[Constants.styleElbow] == Constants.elbowVertical)) ?
        ...
        redrawInnerBends(p0: Point, pe: Point) {
            ...
            if (this.manageLabelHandle) {
                ...
                w = Constants.handleSize + 3;
                h = Constants.handleSize + 3;

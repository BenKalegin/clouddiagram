            ...
            if (this.states != null && (this.horizontal || this.vertical) && bounds != null && delta != null) {
                ...
                var snapX = x => {
                    ...
                    if (override) {
                        ...
                        x -= this.graph.panDx;
                        this.guideX.points = [new Point(x, -this.graph.panDy), new Point(x, c.scrollHeight - 3 - this.graph.panDy)];
                    }
                ...
                var snapY = y => {
                    ...
                    if (override) {
                        ...
                        var c = this.graph.container;
                        y -= this.graph.panDy;
                        this.guideY.points = [new Point(-this.graph.panDx, y), new Point(c.scrollWidth - 3 - this.graph.panDx, y)];
                    }

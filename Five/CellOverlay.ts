module Five {
    ...
    export class CellOverlay {
        constructor(public image: Image, private tooltip?: string, 
            private align: string = Constants.alignRight, 
            private verticalAlign: string = Constants.alignBottom, 
        ...
        getBounds(state: CellState) : Rectangle{
            ...
            if (isEdge) {
                ...
                if (this.align == Constants.alignLeft) {
                    pt.x = state.x;
                }
                else if (this.align == Constants.alignCenter) {
                ...
                if (this.verticalAlign == Constants.alignTop) {
                    pt.y = state.y;
                }
                else if (this.verticalAlign == Constants.alignMiddle) {

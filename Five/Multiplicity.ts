module Five {
    ...
    export class Multiplicity {
        ...
        checkNeighbors(graph: Graph, edge: Cell, source: Cell, target: Cell) {
            ...
            var sourceValue = <Element>graph.getModel().getValue(source);
            var targetValue = <Element>graph.getModel().getValue(target);
        ...
        private checkTerminal(graph: Graph, terminal: Cell, edge: Cell) {
            ...
            var value = graph.getModel().getValue(terminal);

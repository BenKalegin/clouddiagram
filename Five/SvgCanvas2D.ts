module Five {
    export class SvgCanvas2D extends AbstractCanvas2D {
        ...
        rect(x: number, y: number, w: number, h: number): void {
            ...
            n.setAttribute("x", "" + this.format1((x + s.dx) * s.scale));
            n.setAttribute("y", "" + this.format1((y + s.dy) * s.scale));
            n.setAttribute("width", "" + this.format1(w * s.scale));
            n.setAttribute("height", "" + this.format1(h * s.scale));
            this.node = n;
        ...
        text(x: number, y: number, w: number, h: number, str, align: string, valign: string, wrap: boolean, format: string, overflow: string, clip: boolean, rotation: number): void {
		...
		foreignObjectText(x: number, y: number, w: number, h: number, str, align: string, valign: string, wrap: boolean, format: string, overflow: string, clip: boolean, rotation: number, s: CanvasState) {
			...
			var tmp: number;
			var ws: string;
			if (Client.isIe && (document.documentMode == 9 || !Client.isSvg)) {
        ...
        // Private helper function to create SVG elements
        createDiv(str: string, align: string, valign: string, style: string, overflow: string): HTMLDivElement {
            var s = this.state;
            ...
            if ((s.fontStyle & Constants.fontBold) == Constants.fontBold) {
                style += "font-weight:bold;";
            }

            if ((s.fontStyle & Constants.fontItalic) == Constants.fontItalic) {
                style += "font-style:italic;";
            }

            if ((s.fontStyle & Constants.fontUnderline) == Constants.fontUnderline) {
        ...
        createAlternateContent(fo: Element, x: number, y: number, w: number, h: number, str, align, valign, wrap: boolean, format: string, overflow: string, clip: boolean, rotation: number) {
        ...
        plainText(x: number, y: number, w: number, h: number, str: string, align: string, valign: string, wrap: boolean, overflow: string, clip: boolean, rotation: number) {
            rotation = (rotation != null) ? rotation : 0;
            var s = this.state;
            ...
            // Default is left
            var anchor = (align == Constants.alignRight) ? "end" :
                (align == Constants.alignCenter) ? "middle" :
                "start";
        ...
        private addTextBackground(node: SVGGElement, str: string, x: number, y: number, w: number, h: number, align: string, valign: string, overflow: string) {
            var s = this.state;
        ...
        createShadow(node: Element): Node {
            var shadow = <Element>node.cloneNode(true);
            var s = this.state;

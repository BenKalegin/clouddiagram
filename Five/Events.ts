/// <reference path="../typings/touch/TouchEvent.d.ts" />
...
module Five {
    ...
    export class Events {
        ...
        static getSource(event: Event): Element {
            /// <summary>Returns the event's target or srcElement depending on the browser.</summary>
            return (event.srcElement != null) ? event.srcElement : <Element>event.target;
        }
        ...
        */
        ...
        static getMainEvent(e: Event) {
            var touchEvent: ITouchEvent;
            if ((e.type == "touchstart" || e.type == "touchmove")) {
                touchEvent = <ITouchEvent>e;
        ...
        static getClientX(mouseEvent: MouseEvent): number {
            return Events.getMainEvent(mouseEvent).clientX;
        }

        static getClientY(mouseEvent: MouseEvent): number {
            return Events.getMainEvent(mouseEvent).clientY;
        }
        ...
        private static removeAllListeners(element: Element) {
         ...
         */
        static release(element: Element) {
            ...
            if (element != null) {
                ...
                if (children != null) {
                    ...
                    for (var i = 0; i < childCount; i += 1) {
                        Events.release(<Element>children[i]);
                    }
                }
            }
        }
        ...
        static isLeftMouseButton(evt: MouseEvent): boolean {
            return evt.button == ((Client.isIe && (typeof (document.documentMode) === "undefined" || document.documentMode < 9)) ? 1 : 0);
        }
        ...
        */
        ...
        static isTouchEvent(evt: MouseEvent) {
            ...
            if ((<any>evt).pointerType != null) {
                ...
                return pe.pointerType == "touch" || pe.pointerType === pe.MSPOINTER_TYPE_TOUCH;
            } else
    ...
    export class AlignCellsEvent extends BasicEvent {
        constructor(public cells: Cell[], public align: string) { super() }
    }

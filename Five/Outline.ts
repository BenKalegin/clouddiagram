    ...
    export class Outline implements IMouseListener {
     /* container - DOM node that will contain the outline.  */
        ...
        private createGraph(container: HTMLElement) {
            var graph = new Graph(container, this.source.getModel(), this.graphRenderHint, this.source.getStylesheet());
        ...
        private init(container: HTMLElement) {
            ...
            this.outline.graphModelChanged = () => {
            ...
            Events.addListener(this.source.container, 'scroll', this.updateHandler);
        ...
        update(revalidate: boolean = false) {
            if (this.source != null && this.outline != null) {
                ...
                var unscaledFinderBounds = new Rectangle(0, 0,
        ...
        mouseDown(sender: Object, me: MouseEventContext) {
            if (this.enabled && this.showViewport) {
                ...
                if (this.source.useScrollbarsForPanning && Utils.hasScrollbars(this.source.container)) {

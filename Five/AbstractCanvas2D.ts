module Five { 
    export class AbstractCanvas2D {
        ...
        text(x: number, y: number, w: number, h: number, str, align, valign, wrap: boolean, format: string, overflow: string, clip: boolean, rotation: number) { throw new Error("Not implemented"); }

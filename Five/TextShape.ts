...
module Five {
    ...
    export class TextShape extends Shape {
        ...
        constructor(
            ...
            private overflow: string = "visible",
         ...
         */
        textWidthPadding = (document.documentMode == 8) ? 4 : 3;
        ...
        apply(state: CellState) {
            ...
            if (this.style != null) {
                this.fontStyle = Utils.getInt(this.style, Constants.styleFontstyle, this.fontStyle);
                this.family = Utils.getValue(this.style, Constants.styleFontfamily, this.family);
                this.size = Utils.getInt(this.style, Constants.styleFontsize, this.size);
                this.color = Utils.getValue(this.style, Constants.styleFontcolor, this.color);
                this.align = Utils.getValue(this.style, Constants.styleAlign, this.align);
                this.valign = Utils.getValue(this.style, Constants.styleVerticalAlign, this.valign);
                this.spacingTop = Utils.getInt(this.style, Constants.styleSpacingTop, this.spacingTop);
                this.spacingRight = Utils.getInt(this.style, Constants.styleSpacingRight, this.spacingRight);
                this.spacingBottom = Utils.getInt(this.style, Constants.styleSpacingBottom, this.spacingBottom);
                this.spacingLeft = Utils.getInt(this.style, Constants.styleSpacingLeft, this.spacingLeft);
                this.horizontal = Utils.getBoolean(this.style, Constants.styleHorizontal, this.horizontal);
                this.background = Utils.getValue(this.style, Constants.styleLabelBackgroundcolor, this.background);
                this.border = Utils.getValue(this.style, Constants.styleLabelBordercolor, this.border);
                this.updateMargin();
            }
        }
        ...
        updateBoundingBox() {
            ...
            var h = (this.style != null) ? Utils.getValue(this.style, Constants.styleLabelPosition, Constants.alignCenter) : null;
            var v = (this.style != null) ? Utils.getValue(this.style, Constants.styleVerticalLabelPosition, Constants.alignMiddle) : null;

            if (!this.ignoreStringSize && node != null && this.overflow != "fill" &&
            (!this.clipped || !this.ignoreClippedStringSize || h != Constants.alignCenter || v != Constants.alignMiddle)) {
                var ow = null;
                var oh = null;
        ...
        public redrawHtmlShape() {
            ...
            if (Client.isIe && (document.documentMode == null || document.documentMode <= 8)) {
        ...
        private updateHtmlFilter() {
            ...
            if (Client.isQuirks && (this.clipped || (this.overflow == "width" && h > 0))) {
                h = Math.min(h, oh);
        ...
        private updateFont(node: Element) {
            ...
            if ((this.fontStyle & Constants.fontBold) == Constants.fontBold) {
            ...
            if ((this.fontStyle & Constants.fontItalic) == Constants.fontItalic) {
            ...
            if ((this.fontStyle & Constants.fontUnderline) == Constants.fontUnderline) {
            ...
            if (this.align == Constants.alignCenter) {
                style.textAlign = "center";
            }
            else if (this.align == Constants.alignRight) {
        ...
        getSpacing() {
            ...
            if (this.valign == Constants.alignMiddle) {
                dy = (this.spacingTop - this.spacingBottom) / 2;
            }
            else if (this.valign == Constants.alignBottom) {
        ...
        static factory(
            ...
            return new TextShape(value, bounds, align, value, color, family, size, fontStyle, spacing, spacingTop, spacingRight, spacingBottom, spacingLeft, horizontal, background, border,wrap,clipped,overflow,labelPadding); }
    }
}